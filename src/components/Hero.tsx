      ...
      <div className="container relative z-10 mx-auto px-4">
        <div className="mx-auto max-w-2xl text-center">
          ...
          <motion.p 
            ...
            className="mt-6 text-lg leading-8 text-slate-320"
          >
          ...
          <div className="rounded-2xl bg-white p-4 shadow-2xl md:p-6">
            <div className="grid grid-cols-1 gap-4 md:grid-cols-4">
              <div className="space-y-2">
                ...
                <Input placeholder="e.g. Westlands, Nairobi" className="border-slate-200" />
              </div>
              ...
              <div className="flex items-end">
                <Button className="w-full h-10 gap-2 text-base font-semibold">
